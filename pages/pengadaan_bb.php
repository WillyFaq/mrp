...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800"> <i class="fa fa-boxes"></i> Pengadaan Bahan Baku</h1>
</div>
<?php
    $ket = "Data";
    if(isset($_GET['ket'])){
    ...
    <div class="col mb-4">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary"><?= ucfirst($ket); ?> Pengadaan Bahan Baku</h6>
                <?php
                if(!isset($_GET['ket'])){
                ?>
                <div class="dropdown no-arrow">
                    <a href="index.php?p=pengadaan_bb&ket=tambah" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Tambah Data"><i class="fa fa-plus"></i></a>
                </div>
                <?php } ?>
            </div>
            <div class="card-body">
            ...
            ?>
                <table class="table dataTable">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row['nama_user']; ?></td>
                            <td>
                                <!-- <a href="index.php?p=pengadaan_bb&ket=ubah&id=<?= $row['id_pengadaan'] ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Ubah Data"><i class="fa fa-pencil-alt"></i></a>
                                 -->
                ...
                <?php else: ?>
                <form method="post" action="models/p_pengadaan_bb.php">
