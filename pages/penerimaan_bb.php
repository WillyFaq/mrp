        ...
        <div class="card shadow mb-4">
            ...
            ?>
                <table class="table dataTable">
                    ...
                    <?php
                        $i=0;
                        $sql = "SELECT a.*, b.nama_user, c.nama_bahan, c.satuan FROM pengadaan a JOIN user b ON a.id_user = b.id_user JOIN bahan c ON a.id_bahan = c.id_bahan WHERE a.sts = 0 ORDER BY a.tgl_pengadaan, a.tgl_penerimaan DESC";
                        $q = mysqli_query($con, $sql);
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $row['nama_user']; ?></td>
                            <td><?= $row['tgl_penerimaan']==''?'':date("d-m-Y", strtotime($row['tgl_penerimaan'])); ?></td>
                            <td>
                                <a href="index.php?p=penerimaan_bb&ket=ubah&id=<?= $row['id_pengadaan'] ?>" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="top" title="Terima"><i class="fa fa-check"></i></a>
